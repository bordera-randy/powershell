    ...
    <Grid Margin="14">
        ...
        <Border Grid.Row="0" Background="#FAFAFC" CornerRadius="12" Padding="14" BorderBrush="#E5E7EB" BorderThickness="1">
            <Grid>
                ...
                <StackPanel Grid.Row="5" Grid.Column="4" Orientation="Vertical" HorizontalAlignment="Right">
                    <TextBlock Text="Resource Group (optional)" FontSize="12" FontWeight="Bold" Foreground="#6B7280" HorizontalAlignment="Right"/>
                    <TextBox x:Name="txtResourceGroup" Width="340" Height="28" Margin="0,4,0,0"/>
                </StackPanel>

                <Button x:Name="btnRgCopy" Grid.Row="5" Grid.Column="5" Content="Copy" Margin="8,2,0,2" Padding="12,7" FontWeight="Bold" VerticalAlignment="Bottom"/>

                <TextBlock Grid.Row="5" Grid.Column="2" Text="Subscription ID:" FontWeight="SemiBold" VerticalAlignment="Center" Margin="8,0,0,0"/>
...
function Build-Favorites {
    ...
    foreach ($pinName in $pins) {
        ...
        if ($null -eq $center) {
            ...
            $ph.Content = (New-TileContent -GlyphHex "E711" -Text "Pin…" -FontSize 16)
        ...
        $btn.Content = (New-TileContent -GlyphHex $glyph -Text $center.Name -FontSize 16)
        ...
        $favButtons.Add([pscustomobject]@{ Button=$btn; Name=$center.Name; Keywords=(Nz $center.Keywords) }) | Out-Null
    }
}
...
function Build-Buttons {
    ...
    foreach ($center in $centers) {
        ...
        $glyph = "E8A7"
        if ($center.ContainsKey("Icon") -and -not [string]::IsNullOrWhiteSpace([string]$center.Icon)) { $glyph = [string]$center.Icon }
        $btn.Content = (New-TileContent -GlyphHex $glyph -Text $center.Name -FontSize 18)
